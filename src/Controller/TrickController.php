...
class TrickController extends AbstractController
{
    ...
    public function __construct(UploadedFileManager $uploadedFile, TrickRepository $repository)
    {
     ...
     * @Route("/{name}-{id}", name="trick_show", methods={"GET","POST"}, requirements= {"slug": "[a-z0-9\-]*"})
     */
    public function show($name, $id, Request $request): Response
    {
